        ...
        async def on_message(message):
            if message.author == self.client.user:
                ...
                if self.agent:
                    ...
                    response = await self.agent.arun(message_text, user_id=message_user, session_id=thread.id,
                ...
                if response.reasoning_content:
                    await self._send_discord_messages(thread=thread, message=f"Reasoning: \n{response.reasoning_content}", italics=True)
